<?php if( have_rows('hero_banner') ): ?>
    <div class="banner owl-carousel owl-carousel--banner">
        <?php while( have_rows('hero_banner') ): the_row(); ?>
            ...
            <div class="item" />
                <div class="item__background" style="background: url('<?php $print_image = wp_get_attachment_image_src( $slide_image, 'hero_banner' ); echo $print_image[0]; ?>') no-repeat center center;">
